...
class ArtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create art" do
    assert_difference('Art.count') do
      post arts_url, params: { art: { author: @art.author, date: @art.date, dimensions: @art.dimensions, name: @art.name, photo: @art.photo, theme_id: @art.theme_id } }
    end
  ...
  test "should update art" do
    patch art_url(@art), params: { art: { author: @art.author, date: @art.date, dimensions: @art.dimensions, name: @art.name, photo: @art.photo, theme_id: @art.theme_id } }
